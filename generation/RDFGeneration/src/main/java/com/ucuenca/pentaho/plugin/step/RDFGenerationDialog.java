 ...
 * 
 */
public class RDFGenerationDialog extends BaseStepDialog implements StepDialogInterface {
	 ...
	 */
	public RDFGenerationDialog(Shell parent, Object in, TransMeta transMeta, String sname) {
