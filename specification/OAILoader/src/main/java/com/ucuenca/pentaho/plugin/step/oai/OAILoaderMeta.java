...
public class OAILoaderMeta extends BaseStepMeta implements StepMetaInterface {
    ...
    public OAILoaderMeta() {
        ...
        ResponseDateField=null;
    }

    public String getResponseDateField() {
        return ResponseDateField;
    }

    public void setResponseDateField(String ResponseDateField) {
        this.ResponseDateField = ResponseDateField;
    }
    ...
    public void setDefault() {
        ...
        schema = "";
        initialResumptionToken = null;
        ResponseDateField = "ResponseDateField";
    }
    ...
    public String getXML() throws KettleValueException {
        ...
        retval.append("    ").append(XMLHandler.addTagValue("ResponseDateField", ResponseDateField));
    ...
    public void loadXML(Node stepnode, List<DatabaseMeta> databases, Map<String, Counter> counters) throws KettleXMLException {
        ...
        try {
            ...
            setResponseDateField(XMLHandler.getNodeValue(XMLHandler.getSubNode(stepnode, "ResponseDateField")));
        } catch (Exception e) {
    ...
    public void getFields(RowMetaInterface r, String origin, RowMetaInterface[] info, StepMeta nextStep,
        ...
        ValueMetaInterface time = new ValueMeta(BaseMessages.getString(PKG, "OAILoader.InputData.ResponseDate"), ValueMetaInterface.TYPE_STRING);
